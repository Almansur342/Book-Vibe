  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end space-x-0 lg:space-x-3">
          <a className="border px-3 py-1 lg:px-5 lg:py-3 text-xs lg:text-lg font-semibold text-white rounded bg-[#23BE0A]">Sign In</a>
          <a className="border px-3 py-1 lg:px-5 lg:py-3 text-xs lg:text-lg font-semibold text-white rounded bg-[#59C6D2]">Sign Up</a>
        </div>
      </div>
    </div>
