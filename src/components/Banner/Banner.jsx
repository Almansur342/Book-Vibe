  ...
  return (
	...
	<div className="container flex flex-col justify-center p-6 mx-auto py-7  lg:flex-row lg:justify-between">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-xl xl:max-w-xl lg:text-left">
			<h1 className="text-2xl lg:text-5xl font-bold leading-none sm:text-5xl mb-12">Books to freshen up your bookshelf</h1>
			<NavLink to="/Listed Books" className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
